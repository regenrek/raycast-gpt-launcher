...
# Documentation:
# @raycast.description Opens ChatGPT with temporary chat and o3 model
# @raycast.author kregenrek
# @raycast.authorURL https://github.com/kregenrek

# Base URL
base_url="https://chatgpt.com/?model=o3&temporary-chat=true"
