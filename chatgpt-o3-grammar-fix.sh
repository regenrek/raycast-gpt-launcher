...
# @raycast.title ChatGPT o3 Grammar Fix
# @raycast.mode silent
...
# Documentation:
# @raycast.description Opens ChatGPT with o3 model and grammar fix prompt
