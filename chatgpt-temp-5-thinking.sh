...
# @raycast.title ChatGPT 5 Thinking Temp
# @raycast.mode silent
...
# Documentation:
# @raycast.description Opens ChatGPT with temporary chat and GPT-5 Thinking model
# @raycast.author kregenrek
# @raycast.authorURL https://github.com/kregenrek

# Base URL
base_url="https://chatgpt.com/?model=gpt-5-thinking&temporary-chat=true"
